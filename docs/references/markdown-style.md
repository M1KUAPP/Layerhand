...
1.  [Table of contents](#table-of-contents)
    1.  [Use a `[TOC]` directive](#use-a-toc-directive)
    1.  [Place the `[TOC]` directive after the introduction](#place-the-toc-directive-after-the-introduction)
...
1.  `author`: _Optional_. If you'd like to claim ownership of the document or
